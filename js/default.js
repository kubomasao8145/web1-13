var separate_time=function(time){
   var sec = Math.flooar((time/1000)%60);
   var min = Math.flooar((time/1000/60)%60);
   var hours =Math.flooar((time/1000/60/60)%24);
   var days = Math.flooar(time/1000/60/60/24);
...
function setCookie(c_name,value,exporedays){
